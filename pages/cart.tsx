...
export const getServerSideProps: GetServerSideProps = async (context) => {
  ...
  const getAllGames = await mongodb.collection(`cart-${session?.user.nickname}`).find().toArray();
...
const Cart: React.FC<myReactComponent> = ({games, cookie}:any) => {
  ...
  if (user === undefined) return <Layout cookie={cookie}>
